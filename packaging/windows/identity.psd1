...
@{
    ...
    #
    #   Get-AppxPackage Excelano.Slipcase
    #   https://apps.microsoft.com/detail/9MVPSVT3ZV3V
    PackageFamilyName = 'Excelano.Slipcase_nbxmgv0sk86m4'
    StoreId = '9MVPSVT3ZV3V'
}
